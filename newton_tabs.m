...
fprintf('\nTable 1: Error for full Newton kernel\n');
fprintf('========================================================================================\n');
fprintf('  n\\m ');
fprintf('%9d', mlist);
fprintf('\n');
...
fprintf('\nTable 2: Error for long range part of Newton\n');
fprintf('========================================================================================\n');
fprintf('  n\\m ');
fprintf('%9d', mlist);
fprintf('\n');
...
for ii = 1:num_n
    fprintf('%5d', nlist(ii));
    fprintf('%9.1e', errors_long(ii,:));
    fprintf('\n');
end
fprintf('========================================================================================\n');

fprintf('\nTable 2: Tucker ranks of the long range part\n');
fprintf('========================================================================================\n');
fprintf('  n\\m ');
fprintf('%9d', mlist);
fprintf('\n');
...
for ii = 1:num_n
    fprintf('%5d', nlist(ii));
    fprintf('%9d', TuckerRanks_long(ii,:));
    fprintf('\n');
end
fprintf('========================================================================================\n');
end